...
urlpatterns = [
    ...
    re_path(r'^events/available/$', available_events, name='available_events'),
    re_path(r'^events/my-applications/$', user_event_applications, name='user_event_applications'),
    re_path(r'^events/apply/(?P<event_id>\d+)/$', apply_to_event, name='apply_to_event'),
]
