...
CSRF_TRUSTED_ORIGINS = [
    "https://web-production-b6be8.up.railway.app",
...
DATABASE_URL = "postgresql://neondb_owner:npg_q1sLc6pfuaHt@ep-withered-fog-a9tt4wp4-pooler.gwc.azure.neon.tech/neondb?sslmode=require"
...
cloudinary.config( 
    cloud_name = "dwrc9q9kr", 
    api_key = "433845513149297", 
    api_secret = "HKyVflSVPzgV3Ubo18rlhz6P9zU", 
)
...
CKEDITOR_CONFIGS = {
    'default': {
        ...
        'contentsCss': '/static/ckeditor/ckeditor/plugins/ckeditor_custom.css',
        'extraAllowedContent': 'img[!src,alt,width,height]; div(*){*}[*]; p(*){*}[*]',
...
EMAIL_HOST_USER = 'support@brightstarfinancefx.com'
EMAIL_HOST_PASSWORD = 'Support511$$'
DEFAULT_FROM_EMAIL = 'support@brightstarfinancefx.com'
