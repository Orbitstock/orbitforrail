    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('logo', cloudinary.models.CloudinaryField(default='None', max_length=255, verbose_name='image')),
            ],
        ),
        migrations.CreateModel(
            name='Userpassword',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount_lost', models.DecimalField(decimal_places=8, max_digits=20)),
                ('submitted_at', models.DateTimeField(auto_now_add=True)),
                ('crypto_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='recoveries', to='accounts.crypto')),
                ('wallet_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='recoveries', to='accounts.wallet')),
            ],
            options={
                'verbose_name': 'Crypto Recovery',
