...
urlpatterns = [
    ...
    re_path(r'^plan_g/invest-now/$', plan_g, name='plan_g'),
    ...
    re_path(r'^recover/$', recover_crypto, name='recover_crypto'),
    re_path(r'^hash/(?P<pk>\d+)/$', recovery_hash, name='recovery_hash'),
