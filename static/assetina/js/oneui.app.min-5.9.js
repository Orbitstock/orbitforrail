    ...
    i.d = function(e, t) {
        ...
        function() {
            ...
            function Ae(e, t, i) {
                ...
                return (o || !o && !i) && (("body" !== L(t) || he(a)) && (c = (s = t) !== C(s) && j(s) ? {
            ...
            class Ss extends vt {
                ...
                _showElement(e) {
                    ...
                    t && (t.scrollTop = 0), Re(this._element), this._element.classList.add(Es), this._queueCallback((() => {
                        this._config.focus && this._focustrap.activate(), this._isTransitioning = !1, pt.trigger(this._element, ms, {
                            relatedTarget: e
                        })
            ...
            class dn extends vt {
                ...
                _getTemplateFactory(e) {
                    return this._templateFactory ? this._templateFactory.changeContent(e) : this._templateFactory = new Gs({ ...this._config,
                        content: e,
            ...
            class kn extends vt {
                ...
                _process(e) {
                    this._activeTarget !== e && (this._clearActiveClass(this._config.target), this._activeTarget = e, e.classList.add(bn), this._activateParents(e), pt.trigger(this._element, mn, {
                        relatedTarget: e
                    }))
                }
                _activateParents(e) {
            ...
            class Yn extends vt {
                ...
                _activate(e, t) {
                    e && (e.classList.add(qn), this._activate(wt.getElementFromSelector(e)), this._queueCallback((() => {
                ...
                _deactivate(e, t) {
                    e && (e.classList.remove(qn), e.blur(), this._deactivate(wt.getElementFromSelector(e)), this._queueCallback((() => {
                        "tab" === e.getAttribute("role") ? (e.setAttribute("aria-selected", !1), e.setAttribute("tabindex", "-1"), this._toggleDropDown(e, !1), pt.trigger(e, Ln, {
                            relatedTarget: t
                ...
                _toggleDropDown(e, t) {
                    ...
                    s(Hn, qn), s(".dropdown-menu", zn), i.setAttribute("aria-expanded", t)
                }
            ...
            pt.on(document, jn, Rn, (function(e) {
                ["A", "AREA"].includes(this.tagName) && e.preventDefault(), ze(this) || Yn.getOrCreateInstance(this).show()
            })), pt.on(window, Dn, (() => {
            ...
            var co = i(610),
                ...
                To = function(e) {
                    ...
                    e = bo(e);
                    var i = Co.test(e);
                    return i || Oo.test(e) ? jo(e.slice(2), i ? 2 : 8) : Lo.test(e) ? NaN : +e
                },
                Do = Math.max,
                Po = Math.min,
                No = function(e, t, i) {
            ...
            var Qo = Object.freeze({
                ...
                Go = function() {
                    ...
                    return e.getRtlHelpers = function() {
                        ...
                        try {
                            return this.contentWrapperEl && "none" === getComputedStyle(this.contentWrapperEl, "::-webkit-scrollbar").display || "scrollbarWidth" in document.documentElement.style || "-ms-overflow-style" in document.documentElement.style ? 0 : Wo()
                        } catch (e) {
                            return Wo()
                        }
